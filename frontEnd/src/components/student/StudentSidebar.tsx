...
//       <div
//         ref={sidebarRef}
//         className={`w-64 bg-gradient-to-b from-blue-700 to-blue-800 h-screen fixed lg:static transform ${
//           isOpen ? "translate-x-0" : "-translate-x-full"
//         } lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 flex flex-col shadow-xl`}
//       >
//         {/* Logo Section */}
//         <div className="flex h-[100px] items-center justify-center py-6 bg-blue-800 shadow-inner">
//           <img src={logo} alt="Logo" className="h-12 w-auto drop-shadow-md" />
//         </div>

//         {/* Profile Section */}
//         <div className="flex justify-center items-center py-4 bg-blue-900/30 border-b border-blue-600/30">
...
//                 }
//               >
//                 <ChartBarIcon className={`h-5 w-5 ${({ isActive }: { isActive: boolean }) => isActive ? "text-blue-700" : "text-blue-300"}`} />
...
//                 }
//               >
//                 <User className={`h-5 w-5 ${({ isActive }: { isActive: boolean }) => isActive ? "text-blue-700" : "text-blue-300"}`} />
...
//               >
//                 <MessageCircle className={`h-5 w-5 ${({ isActive }: { isActive: boolean }) => isActive ? "text-blue-700" : "text-blue-300"}`} />
...
//                 }
//               >
//                 <BookOpenIcon className={`h-5 w-5 ${({ isActive }: { isActive: boolean }) => isActive ? "text-blue-700" : "text-blue-300"}`} />
...
//                 }
//               >
//                 <CreditCard className={`h-5 w-5 ${({ isActive }: { isActive: boolean }) => isActive ? "text-blue-700" : "text-blue-300"}`} />
...
//         <div className="mt-auto p-4 border-t border-blue-600/30">
//           <button
//             onClick={handleLogout}
//             className="w-full flex items-center justify-center space-x-3 px-4 py-3 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-white transition-all duration-300"
//           >
